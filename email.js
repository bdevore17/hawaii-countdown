exports.firstHalf = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd"><html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>' +
  '    <!--[if gte mso 9]><xml>' +
  ...
  '                <tbody><tr style="vertical-align: top">' +
  '                  <td width="100%" style="word-break: break-word;border-collapse: collapse !important;vertical-align: top;background-color: #3990FA">' +
  '                    <!--[if gte mso 9]>' +
  ...
  '      <div style="color:#FFFFFF;line-height:120%;font-family:\'Ubuntu\', Tahoma, Verdana, Segoe, sans-serif;">' +
  '       <div style="font-size:12px;line-height:14px;font-family:Ubuntu, Tahoma, Verdana, Segoe, sans-serif;color:#FFFFFF;text-align:left;"><p style="margin: 0;font-size: 18px;line-height: 22px"><span style="font-size: 36px; line-height: 43px;"><strong><span style="line-height: 43px; font-size: 36px;">Only ';

exports.secondHalf = ' Days until Hawaii!</span></strong></span></p></div>' +
  '      </div>' +
  '    </td>' +
  '  </tr>' +
  '</tbody></table>' +
